...
<td class="td-table-menu">
  <a href="#" OnClick = "writecookie('','recordset_action','delete'); ShowElement('overlay'); ShowElement('forms'); AjaxShow(':::edit.php:forms:');">
	<img src="lib/img/recordset/table_row_delete.png" title="<?php echo DELETE_ROW;?>" alt="<?php echo DELETE_ROW;?>" class="menu">
	</a>
</td>

<td class="td-table-menu">
  <a href="#" OnClick="writecookie('','recordset_action','insert'); ShowElement('overlay'); ShowElement('forms'); AjaxShow(':::edit.php:forms:');">
...
<td class="td-table-menu">
  <a href="#" OnClick="javascript:writecookie('','recordset_action','copy'); ShowElement('overlay'); ShowElement('forms'); AjaxShow(':::edit.php:forms:');">
 	<img src="lib/img/recordset/page_copy.png" title="<?php echo COPY_ROW;?>" alt="<?php echo COPY_ROW;?>" class="menu">
	</a>
</td>

<td class="td-table-menu">
  <a href="#" OnClick="writecookie('','recordset_action','update');  ShowElement('overlay'); ShowElement('forms'); AjaxShow(':::edit.php:forms:');">
...
<td class="td-table-menu">
  <a href="#" OnClick="writecookie('','recordset_action','browse');  ShowElement('overlay'); ShowElement('forms'); AjaxShow(':::view.php:forms:');">
